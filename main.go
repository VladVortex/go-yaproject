...
func (r Running) Calories() float64 {
	// r.meanSpeed() берется из базовой структуры Training
...
func (s Swimming) Calories() float64 {
	// Важно вызывать s.meanSpeed(), так как он переопределен для Swimming
...
func (s Swimming) TrainingInfo() InfoMessage {
	// Здесь мы не можем просто вызвать s.Training.TrainingInfo(),
	// потому что метод TrainingInfo у родителя вызовет meanSpeed() родителя (Training),
	// а нам нужен meanSpeed() от Swimming. Поэтому собираем структуру вручную.
	return InfoMessage{
